...
print("=" * 60)
print("ENTRAÎNEMENT LSTM (Deep Learning)")
print("=" * 60)
...
# 10. CALCULER TOUTES LES MÉTRIQUES
...
metrics_df.to_csv('metrics/lstm_metrics.csv', index=False)



print("\n" + "=" * 60)
print("✅ LSTM ENTRÂÎNÉ ET ÉVALUÉ!")
print(f"📁 Modèle: models/lstm_model.h5")
print(f"📊 Métriques: metrics/lstm_metrics.csv")
print("=" * 60)
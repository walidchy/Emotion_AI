...
metrics_df.to_csv('metrics/knn_metrics.csv', index=False)

print("\n" + "=" * 60)
print("✅ KNN ENTRÂÎNÉ ET ÉVALUÉ!")
print(f"📁 Modèle: models/knn_model.pkl")
print(f"📊 Métriques: metrics/knn_metrics.csv")
print("=" * 60)
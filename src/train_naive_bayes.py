...
# 8. Sauvegarder métriques dans CSV
metrics_data = {
    'Model': ['Naive Bayes'],
    'Accuracy': [accuracy],
...
metrics_df.to_csv('metrics/naive_bayes_metrics.csv', index=False)

print("\n" + "=" * 60)
print("✅ NAÏVE BAYES ENTRÂÎNÉ ET ÉVALUÉ!")
print(f"📁 Modèle: models/naive_bayes_model.pkl")
print(f"📊 Métriques: metrics/naive_bayes_metrics.csv")
print("=" * 60)
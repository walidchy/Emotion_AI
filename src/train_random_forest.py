...
for word, importance in top_features.items():
...
metrics_df.to_csv('metrics/random_forest_metrics.csv', index=False)

# Sauvegarder top features
top_features.to_csv('metrics/random_forest_top_features.csv')

print("\n" + "=" * 60)
print("✅ RANDOM FOREST ENTRÂÎNÉ ET ÉVALUÉ!")
print(f"📁 Modèle: models/random_forest_model.pkl")
print(f"📊 Métriques: metrics/random_forest_metrics.csv")
print("=" * 60)